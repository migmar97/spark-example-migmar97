...
public class MockitoTests {
	...
	public void MockListSize() {
		...
		when(list.size()).thenReturn(10); // comportamiento de list cuando llamen a size.
	...
	public void MockListSizeWithMultipleReturnValues() {
		List list = mock(List.class);
		when(list.size()).thenReturn(10).thenReturn(20); // la primera vez devuelve un 10, la segunda 20 y siguientes 20
		...
		verify(list, times(3)).size(); // comprueba que se ha llamado 3 veces a su metodo size de list.
	}
